...
hexo.extend.filter.register('after_generate', function (locals) {
    ...
    <link  rel="stylesheet" type="text/css" href="https://gteam_seven.gitee.io/love/css/calendar_card.css">
...
`
        //脚本资源
        const js_text = `<script data-pjax src="https://gteam_seven.gitee.io/love/js/calendar.js"></script>`
        // 挂载的位置
